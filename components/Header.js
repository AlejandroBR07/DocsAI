...
import { TeamIcon, SettingsIcon, CheckIcon, AlertTriangleIcon, UserIcon } from './Icons.js';
...
const Header = ({ currentTeam, onTeamChange, onOpenApiSettings, onOpenResponsibleSettings, apiKeyStatus, responsiblePerson }) => {
  return (
    React.createElement('header', { className: "bg-gray-800/50 backdrop-blur-sm p-4 sticky top-0 z-20 border-b border-gray-700" },
      React.createElement('div', { className: "container mx-auto flex justify-between items-center" },
        ...
        React.createElement('div', { className: "flex items-center gap-2 sm:gap-4" },
          ...
          React.createElement(ApiStatusIndicator, { status: apiKeyStatus, onClick: onOpenApiSettings }),
          React.createElement('button', {
