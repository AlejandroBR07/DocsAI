  ...
  try {
    ...
    switch (team) {
      ...
      case Team.Automations:
        persona = 'Aja como um especialista em automação de processos (RPA e integrações), com conhecimento em plataformas visuais como N8N/Make e também em ferramentas de automação de conversas como Unnichat para WhatsApp. Sua tarefa é criar a documentação mais detalhada possível, exclusivamente em Português do Brasil.';
        break;
      case Team.AI:
    ...
    const mainPrompt = `
      ...
      **Instruções Chave:**
      ...
      1.  **Documente o Presente, Não o Futuro (REGRA CRÍTICA):** Sua única função é documentar o estado **ATUAL** do projeto. É estritamente **PROIBIDO** sugerir melhorias, funcionalidades futuras, otimizações de código, ou criar seções de "Próximos Passos" ou "A Fazer". A documentação deve ser um reflexo fiel do que existe, não do que poderia existir.
